...
const routes = [
  { path: '/login', component: () => import('./views/LoginView.vue') },
  {
    ...
    children: [
      ...
      { path: 'vehicle/:id/parking', component: () => import('./views/ParkingListView.vue'), meta: { title: '停车' } },
      { path: 'vehicle/:id/parking/:pid', component: () => import('./views/ParkingDetailView.vue'), meta: { title: '车位详情' } },
      { path: 'vehicle/:id/parking/new', component: () => import('./views/ParkingFormView.vue'), meta: { title: '添加车位' } },
      { path: 'vehicle/:id/parking/:pid/edit', component: () => import('./views/ParkingFormView.vue'), meta: { title: '编辑车位' } },
